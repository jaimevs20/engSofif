 ...
 * @author iMurilo Cruz
 */
public class TelaCadastrarSecretario extends javax.swing.JFrame {

    /**
     * Creates new form TelaLogin
     */
    public TelaCadastrarSecretario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastrarSecretario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastrarSecretario().setVisible(true);
            }
        });
    }
